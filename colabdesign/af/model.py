...
class mk_af_model(design_model, _af_inputs, _af_loss, _af_prep, _af_design, _af_utils):
  def __init__(self,
    ...
    self.opt = {"dropout":True, "pssm_hard":False, "learning_rate":0.1, "norm_seq_grad":True,
                ...
                "i_con_1":    {"num":1, "cutoff":21.0, "binary":False, "num_pos":float("inf")},#21.6875  
                "i_con_2":    {"num":1, "cutoff":21.0, "binary":False, "num_pos":float("inf")},
                "i_con":    {"num":1, "cutoff":21.0, "binary":False, "num_pos":float("inf")},
